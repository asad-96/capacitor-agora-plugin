...
//        ), for: .normal)
        ...
        button.setImage(MPImage(named: unselected), for: .normal)
#elseif os(macOS)
    ...
    public static var cameraRotateSymbol = "ic-switch-camera"
    ...
    public static var screenShareSymbol = "ic-switch-camera"
    /// SF Symbol name for pin icon
    public static var pinSymbol = "pin.fill"
    public static var chatSymbol = "ic-chat"
    public static var endcallSymbol = "ic-end-call"
    static var layoutSymbol = "ic-layout"
    static var bluetoothSymbol = "ic-bluetooth"
    static var flashSymbol = "ic-camera-flash"
